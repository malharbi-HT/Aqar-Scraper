...
LIST_PAGES = [
    "https://sa.aqar.fm/عمائر-للبيع/الرياض/شمال-الرياض",
    "https://sa.aqar.fm/عمائر-للبيع/الرياض/شرق-الرياض",
    "https://sa.aqar.fm/عمائر-للبيع/الرياض/غرب-الرياض",
    "https://sa.aqar.fm/عمائر-للبيع/الرياض/جنوب-الرياض",
    "https://sa.aqar.fm/عمائر-للبيع/الرياض/وسط-الرياض",
]
...
OUTPUT_CSV = os.path.join(DATA_DIR, "listings_building.csv")
...
def parse_city_direction_from_url(url):
    ...
    مثال: /عمائر-للبيع/الرياض/شمال-الرياض/حي-الياسمين/... -> (الرياض, شمال الرياض)"""
