...
LIST_PAGES = [
    "https://sa.aqar.fm/فلل-للبيع/الرياض/شمال-الرياض",
    "https://sa.aqar.fm/فلل-للبيع/الرياض/شرق-الرياض",
    "https://sa.aqar.fm/فلل-للبيع/الرياض/غرب-الرياض",
    "https://sa.aqar.fm/فلل-للبيع/الرياض/جنوب-الرياض",
    "https://sa.aqar.fm/فلل-للبيع/الرياض/وسط-الرياض",
]
...
def parse_city_direction_from_url(url):
    ...
    مثال: /فلل-للبيع/الرياض/شمال-الرياض/حي-الياسمين/... -> (الرياض, شمال الرياض)"""
