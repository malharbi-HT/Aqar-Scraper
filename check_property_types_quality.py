...
SANITY_RANGES = {
    ...
    # الأراضي: نطاق سعر أوسع بكثير -- أراضٍ تجارية/صناعية كبيرة تصل لمئات الملايين
    # مشروع فعليًا، لهذا رفعنا الحد الأعلى. الحد الأدنى نزّلناه شوي لالتقاط الأخطاء
    # الحقيقية (أسعار زهيدة جدًا كمؤشر خطأ بيانات، مثل سعر إيجار انسحب بالغلط).
    "land":     {"price": (10_000, 500_000_000), "area_sqm": (50, 50_000)},
    # العمائر: نزّلنا الحد الأدنى للمساحة -- عمائر صغيرة نسبيًا (زي 148م²) طبيعية وموجودة فعليًا
