...
MAX_PAGES_PER_CATEGORY = 500   # رفعناها عشان شمال الرياض فيها ~10,534 إعلان (يحتاج ~420 صفحة)   # سقف أعلى من الحاجة الفعلية؛ السكربت يتوقف تلقائيًا عند آخر صفحة فعلية
...
OUTPUT_CSV = os.path.join(DATA_DIR, "listings_rent_north.csv")
