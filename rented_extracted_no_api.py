...
def extract_annual_rent(description, price):
    ...
    annual_patterns = [
        ...
        rf"عقد\s*(?:اجار|إجار|ايجار|إيجار)[^\d]{{0,15}}?({NUM})\s*(?:ألف|الف)?\s*(?:ريال)?\s*سنوي",
        rf"(?:مؤجرة|مؤجر|تؤجر)[^\d]{{0,30}}?(?:بمبلغ|ب|بعقد|بقيمة|بحوالي|بسعر)?\s*({NUM})\s*(?:ألف|الف|[kK])?\s*(?:ريال)?\s*في\s*السنة",
        rf"(?:مؤجرة|مؤجر|تؤجر)[^\d]{{0,30}}?(?:بمبلغ|ب|بعقد|بقيمة|بحوالي|بسعر)?\s*({NUM})\s*(?:ألف|الف|[kK])\b",
        rf"(?:مؤجرة|مؤجر|تؤجر)[^\d]{{0,30}}?(?:بمبلغ|ب|بعقد|بقيمة|بحوالي|بسعر)?\s*({NUM})\s*(?:ريال|﷼)",
    ]
    ...
    fallback_patterns = [
        rf"(?:مؤجرة|مؤجر|تؤجر)[^\d]{{0,20}}?(?:بعقد|بمبلغ|بقيمة|بسعر)\s*({NUM})\b",
        # "مؤجرة بـ X لسنة واحدة" -- بدون كلمة ريال، بس مع مؤشر سنوي واضح
        rf"(?:مؤجرة|مؤجر)[^\d]{{0,15}}?({NUM})\s*(?:ألف|الف|[kK])?\s*لسنة\s*واحدة",
