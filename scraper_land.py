...
LIST_PAGES = [
    "https://sa.aqar.fm/أراضي-للبيع/الرياض/شمال-الرياض",
    "https://sa.aqar.fm/أراضي-للبيع/الرياض/شرق-الرياض",
    "https://sa.aqar.fm/أراضي-للبيع/الرياض/غرب-الرياض",
    "https://sa.aqar.fm/أراضي-للبيع/الرياض/جنوب-الرياض",
    "https://sa.aqar.fm/أراضي-للبيع/الرياض/وسط-الرياض",
]
...
OUTPUT_CSV = os.path.join(DATA_DIR, "listings_land.csv")
...
def parse_city_direction_from_url(url):
    ...
    مثال: /أراضي-للبيع/الرياض/شمال-الرياض/حي-الياسمين/... -> (الرياض, شمال الرياض)"""
