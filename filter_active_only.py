...
LISTINGS_PATH = os.path.join(DATA_DIR, "listings_sale.csv")
STATUS_PATH = os.path.join(DATA_DIR, "listings_sale_status.csv")
OUTPUT_PATH = os.path.join(DATA_DIR, "listings_sale_active_only.csv")
