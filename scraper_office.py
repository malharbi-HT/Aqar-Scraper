...
LIST_PAGES = [
    "https://sa.aqar.fm/مكاتب-للبيع/الرياض/شمال-الرياض",
    "https://sa.aqar.fm/مكاتب-للبيع/الرياض/شرق-الرياض",
    "https://sa.aqar.fm/مكاتب-للبيع/الرياض/غرب-الرياض",
    "https://sa.aqar.fm/مكاتب-للبيع/الرياض/جنوب-الرياض",
    "https://sa.aqar.fm/مكاتب-للبيع/الرياض/وسط-الرياض",
]
...
OUTPUT_CSV = os.path.join(DATA_DIR, "listings_office.csv")
...
def parse_city_direction_from_url(url):
    ...
    مثال: /مكاتب-للبيع/الرياض/شمال-الرياض/حي-الياسمين/... -> (الرياض, شمال الرياض)"""
